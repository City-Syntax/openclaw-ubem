...
- **Cooling setpoint**: IDFs may show 25°C (Climate Studio default) but setpoints reflect each building's actual operational settings. **Never change Cooling_Setpoint_C** — not in pre-flight, not in calibration, not ever.
